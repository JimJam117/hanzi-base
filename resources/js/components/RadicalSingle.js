...
export default function RadicalSingle(props) {
    ...
    const fetchItems = async (apiUrl = `/api/radical/search/${props.radical}?page=${currentPage}`) =>  {
        console.log("load");
...
if (document.getElementById('radical-single')) {
    const element = document.getElementById('radical-single');
    const props = Object.assign({}, element.dataset);
    console.log(element);
    ReactDOM.render(<RadicalSingle {...props}/>, element);
}
